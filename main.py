...
def fetch_poster(movie_id):
    ...
    '{}?api_key=1ef8b3ffdd4691f44c60f759aae5ba3e&language=en-US'.format(movie_id))
...
selected_movie_name=st.selectbox("How would you like to be conected?",movies['title'].values)
